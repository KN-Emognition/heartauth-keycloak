...
public class EcgAuthenticatorFactory implements AuthenticatorFactory {
    ...
    @Override public String getDisplayType() { return "ECG Phone Approval (mock)"; }
    ...
    @Override public String getHelpText() { return "Shows a page asking user to approve on phone (mocked)."; }
